...
class Dialog extends Component {
    ...
    getDeckSuggestion() {
        ...
        let getAnswerFinal = () => {
            return wrongOrCorrect.answerPercent + "% optó por el artículo (" + itemsQuestion[wrongOrCorrect.answerChosen] + ")";
        };
        return (
            <div>
                <div>
            ...
            <div>
                <div className="col-xs-12">
                    ...
                    <div className="col-sm-12 col-md-9 col-xl-9 col-lg-9">
                        <p className="descriptionGuess">{`O(a) ${careers} afirma que la respuesta correcta es: `}</p>
    ...
    getContentLose() {
        return (
            <div className="loadingRanking">Cargando Clasificacion...</div>    
        );
    }
    ...
    getContentScore() {
        ...
        return (
            <div className="col-xs-12">
                <ul>
                    <li className="rankingList"><div className={"pointFinal" + status}>{this.props.winEasterEggs ? '¡Felicidades, has ganado!': 'No ha alcanzado el porcentaje requerido para ganar. Inténtalo de nuevo. :)'}</div></li>
                    <li className="rankingList"><div className="pointFinal">Puntaje Final: {this.props.point}</div></li>
                    <li className="rankingList center">Clasificacion:</li>                    
                    {renderRanking()}
                </ul>
            </div>
        );
